...
#%% ARRANGE
data_AOD = data_aod[['AOD_440nm','AOD_500nm','AOD_675nm','AOD_870nm','AOD_1020nm','Precipitable_Water(cm)','440-870_Angstrom_Exponent']] 
...
data_DEP = data_dep[['Lidar_Ratio[440nm]','Depolarization_Ratio[1020nm]']]
...
# aero.to_csv(path+'_new_parameter.csv')
